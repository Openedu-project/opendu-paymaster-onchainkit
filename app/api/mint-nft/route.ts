...
const API_KEY = process.env.OPENEDU_API_KEY || 'mvYHRnSa7qL15JKbZp3wfNreFGxtDhPoQVuT2yesUC8kj4izM6xcBsA5rmXLlSPd';
const API_ENDPOINT = process.env.OPENEDU_API_ENDPOINT || 'https://opendu-paymaster-production.up.railway.app/api/v1/mint-nft';
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Make sure we're not double-nesting the data
